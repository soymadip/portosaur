...
| **`image`**                  | _None_                     | Cover or thumbnail image that will be used as the <meta property="og:image" content="..."/> in the <head>, enhancing link previews on social media and messaging platforms.                                                                                                 |
